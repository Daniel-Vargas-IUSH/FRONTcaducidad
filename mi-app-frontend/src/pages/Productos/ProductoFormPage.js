...
                />
                ...
                {/* --- CAMBIO CLAVE: Usa 'disabled' para bloquear el stock en modo edición --- */}
                <Input 
...
                    onChange={handleChange}
                    required
                    // Deshabilita la edición si estamos editando un producto
                    disabled={isEditMode} 
                    // readOnly como respaldo visual/funcional si el input lo soporta
                    readOnly={isEditMode} 
                    // Clase para estilizar como bloqueado (asumiendo que 'form-input-readonly' existe en FormPage.css)
